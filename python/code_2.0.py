...
def get_image():
    ...
    if request.args.get('test') == '1':
        ...
        scale = '1.0'
        if channel not in ['prs', 'tev', 'v02', 'v03']:
            print('Channel error: channel undefined')
            return
        if int(phi) == -1:
            theta = '0'
...
tf_number = {'prs': '3', 'tev': '2', 'v02': '4', 'v03': '1'}
# tf_log = {'prs': False, 'tev': True, 'v02': False, 'v03': False}
# tf_number = {'prs': '3', 'tev': '1', 'v02': '1', 'v03': '0'}
...
def import_preset_tf():
    ...
    for channel in tf_number:
        preset_tf = 'SciVis2018_' + str(channel) + '_' + tf_number[channel]
        successImport = ImportPresets(filename = directory_tf + preset_tf + '.json')
        if successImport == True:
            print('Import TF ' + preset_tf + ' successfully.')
        else:
            print('Import Error: Failed to import TF ' + preset_tf + '!')
