...
>>>>>>> 28a0990b7009e5da978b9cd60de5211359f39645
        ...
        while True:
            if str_out in finished_image_list:
                ...
                access_time_list.append(filename)
                break
            if (time.time() - start) > 60: # request timeout
                finished_image_list.remove(str_out)
...
<<<<<<< HEAD
    return send_file(directory + '/view_output/'
=======
    return send_file(directory + '/view_output/' + filename, mimetype = 'image/jpg')
>>>>>>> 28a0990b7009e5da978b9cd60de5211359f39645
...
if __name__ == '__main__':
    t_rendering = threading.Thread(target = get_rendering_result)
    t_rendering.start()
